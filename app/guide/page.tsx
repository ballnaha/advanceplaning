        ...
        <Stack spacing={3.5}>
          ...
          <Paper sx={{ p: { xs: 2.5, md: 4 }, borderRadius: 2 }}>
            <Typography variant="body2" sx={{ color: 'text.secondary', mb: 4 }}>
              ตอนโหลดหน้าแรก ระบบจะเรียงตาม 7 ลำดับชั้นตั้งแต่ประเภทเหล็กถึงคิวเดิม ส่วนปุ่ม <strong>"จัดลำดับงานด่วน"</strong> จะเพิ่มการคัดกรองงานใกล้ถึงกำหนดส่งขึ้นก่อน แล้วจึงใช้ลำดับชั้นเดียวกันนี้ภายในแต่ละกลุ่ม:
            </Typography>
            ...
            <Stack spacing={2.5}>
              {[
                {
                  step: 'ขั้นตอนที่ 1',
                  title: 'คัดกรองความเร่งด่วนสูงสุด (เฉพาะปุ่มจัดลำดับงานด่วน)',
                  color: '#dc2626',
                  desc: 'ระบบจะสแกนงานที่มีกำหนดส่งเสร็จ (Finish Date) เกินกำหนดหรือภายในระยะเวลา 3 วันถัดไป แล้วดันงานกลุ่มนี้ขึ้นก่อน หาก Finish Date เท่ากันจะรักษาลำดับเดิมที่ช่วยลดการเปลี่ยนสีและ L/Q โดยยังไม่นำ Status มาเป็นเงื่อนไขคำนวณ',
                },
                {
                  step: 'ขั้นตอนที่ 2',
            ...
            <Stack direction="row" spacing={1.5} sx={{ bgcolor: 'rgba(79, 70, 229, 0.035)', p: 2.5, borderRadius: 2, border: '1px solid rgba(79, 70, 229, 0.1)' }}>
              ...
              <Box>
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 850, color: 'primary.main', mb: 1.5 }}>
                  💡 หลักการเรียงลำดับ ก่อน และ หลัง กดปุ่มจัดเรียงเครื่องนี้:
                </Typography>
                <Typography variant="body2" sx={{ color: 'text.secondary', display: 'block', lineHeight: 1.65, fontSize: '0.875rem', mb: 2 }}>
                  ...
                  <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;<strong>เน้นวันเริ่มผลิตและประสิทธิภาพเครื่องจักร:</strong> ระบบจะจัดกลุ่มตามประเภทเหล็ก (zpg1d), วันเริ่มผลิต (stdate), มิติความกว้าง-ยาว (zpg2d), สี/กลุ่ม L/Q (zpg3d), ขั้นตอนการผลิต (OP / vornr), และรหัส L/Q (zlmat) โดยจะยัง<strong>ไม่ได้ดึง</strong>งานส่งมอบด่วนภายใน 3 วันขึ้นมากองไว้หน้าสุด จนกว่าจะกดปุ่มจัดลำดับงานด่วน
                  <br /><br />
                  • <strong>หลังกดปุ่มจัดลำดับงานด่วน:</strong>
                  <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;<strong>เน้นการส่งมอบงานด่วนไม่ให้ล่าช้าก่อน:</strong> ระบบจะเปิดใช้กฎ <strong>"งานด่วนพิเศษ (Urgent Priority)"</strong> เฉพาะรายการที่ผ่าน Filter ปี เดือน สถานะ Order และ Work Center ที่เลือกอยู่ โดยดึงงานที่มีกำหนดส่งเสร็จ (Finish Date) เกินกำหนดหรือภายใน 3 วันขึ้นก่อน หาก Finish Date เท่ากันจะรักษาลำดับพื้นฐานเดิม งานที่อยู่นอก Filter จะไม่ถูกสลับตำแหน่ง และ Status ยังไม่ถูกนำมาใช้คำนวณความเร่งด่วน
                </Typography>
